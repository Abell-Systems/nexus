...
from nexus.domain.models.snapshot import DatasetPart, DatasetSnapshot, RawBatch
from nexus.domain.protocols.sources import PatentSourceProtocol
from nexus.domain.protocols.storage import CanonicalStoreProtocol, RawStoreProtocol
...
class IngestionPipeline:
    ...
    def ingest_patent_source(
        ...
        manifest_file.write_text(snapshot.model_dump_json(indent=2))
