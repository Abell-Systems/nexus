...
| `INNOGET-1689` | InnoGet | Metallurgy/steel | Broad, lexically loose ask ("improve rebars and beams... material or manufacturing process") — good test of whether BM25/CPC/semantic diverge on an underspecified query. Wayback-confirmed (2023-06-10). |
...
| `INNOGET-1935` | InnoGet | Environmental sensing | "Semiconductor sensing and miniaturization" — plausible semantic-vs-lexical divergence (a semantically related sensor technology may use none of the same surface terms). Wayback-confirmed (2020-10-26). |
...
- **Expected retriever divergence:** `INNOGET-1935` and `INNOGET-2258` are the two most likely to show BM25 (surface terms) vs. semantic (conceptual similarity) disagreement, once the semantic embedding artifact exists.
