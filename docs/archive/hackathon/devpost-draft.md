...
- [ ] **Demo Video (≤ 4 min)**: Script is ready and timed (`docs/archive/hackathon/demo-script.md`), but no video has been recorded/uploaded yet. A script is not a video — do not check this until a YouTube/Vimeo link exists and has been watched end-to-end.
